<template>
  <div>
    <GCard headless>
      ...
      <p>
        The following formats are supported by textlens. At the very least, a file of the respective format can be
      ...
      <section>
        ...
        <FormatModeExplanation>
          ...
          <template #export>
            <p>
              Textlens exports TSV files with the columns <b>word</b>, <b>lemma</b> and <b>pos</b>; in that order.
            </p>
            <code><pre>
word    lemma    pos
hello   hello    INT
world   world    NOU
      ...
      <section>
        ...
        <FormatModeExplanation>
          <template #import>
            When importing, textlens reads the part of speech out of the <b>XPOS</b> column.
          </template>
          <template #export>
            When exporting, textlens fills in the columns <b>ID</b>, <b>FORM</b>, <b>LEMMA</b>, and <b>XPOS</b>.
          </template>
          <template #merge>
            When merging, the original columns are preserved.
          </template>
...
&lt;/w&gt;</pre></code>
          ...
          <template #merge>
            When merging, we add a &lt;provenance&gt; tag for the metadata of the tagger that has been used.
            The lemma and part of speech annotations generated by textlens are added as the last annotations.
            <code><pre>
&lt;w&gt;
  &lt;t&gt;word&lt;/t&gt;
  ...
  <b>&lt;lemma class="word" set="textlens_example"/&gt;
  &lt;pos class="NOU(num=sg)" set="textlens_example"/&gt;</b>
&lt;/w&gt;</pre></code>
          </template>
        </FormatModeExplanation>
      </section>
